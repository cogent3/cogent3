...
class Sequence:
    ...
    def annotation_offset(self, value: int):
        self._seq.slice_record.offset = value
    ...
    def copy(self, exclude_annotations: bool = False, sliced: bool = True):
        ...
        """
        annotation_offset = (
            self.annotation_offset if sliced else self._seq.slice_record.offset
        )
    ...
    def parent_coordinates(self) -> tuple[str, int, int, int]:
        ...
        # todo: this should return the strand and not the reversed flag
