...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "src/cogent3/align/_pairwise_seqs.pyx"
        ]
    },
...
static const char *__pyx_f[] = {
  "src/cogent3/align/../../include/numerical_pyrex.pyx",
  "src/cogent3/align/_pairwise_seqs.pyx",
  "stringsource",
};
...
/* "src/include/numerical_pyrex.pyx":31
 *     int
 * 
...
/* "src/include/numerical_pyrex.pyx":32
 * 
 * ctypedef double[::1] Double1D
 * ctypedef double[:, ::1] Double2D             # <<<<<<<<<<<<<<
 * ctypedef double[:, :, ::1] Double3D
...
/* "src/include/numerical_pyrex.pyx":33
 * ctypedef double[::1] Double1D
 * ctypedef double[:, ::1] Double2D
 * ctypedef double[:, :, ::1] Double3D             # <<<<<<<<<<<<<<
 * ctypedef long[::1] Long1D
...
/* "src/include/numerical_pyrex.pyx":34
 * ctypedef double[:, ::1] Double2D
 * ctypedef double[:, :, ::1] Double3D
 * ctypedef long[::1] Long1D             # <<<<<<<<<<<<<<
 * ctypedef long[:, ::1] Long2D
...
/* "src/include/numerical_pyrex.pyx":35
 * ctypedef double[:, :, ::1] Double3D
 * ctypedef long[::1] Long1D
 * ctypedef long[:, ::1] Long2D             # <<<<<<<<<<<<<<
 * ctypedef long[:, :, ::1] Long3D
...
/* "src/include/numerical_pyrex.pyx":36
 * ctypedef long[::1] Long1D
 * ctypedef long[:, ::1] Long2D
 * ctypedef long[:, :, ::1] Long3D             # <<<<<<<<<<<<<<
 * 
...
static const char __pyx_k_2019_11_15_a[] = "('2019', '11', '15', 'a')";
...
static const char __pyx_k_src_cogent3_align__pairwise_seqs[] = "src/cogent3/align/_pairwise_seqs.pyx";
...
static PyObject *__pyx_kp_s_2019_11_15_a;
...
static PyObject *__pyx_kp_s_src_cogent3_align__pairwise_seqs;
...
/* "src/include/numerical_pyrex.pyx":39
 * 
 * 
...
static int __pyx_fuse_0__pyx_f_7cogent3_5align_14_pairwise_seqs_checkDim(PyObject *__pyx_v_dimension, Py_ssize_t __pyx_v_val, Py_ssize_t *__pyx_v_var) {
  ...
  /* "src/include/numerical_pyrex.pyx":40
 * 
 * cdef int checkDim(dimension, Py_ssize_t val, dim *var) except 1:
 *     if var[0] == 0:             # <<<<<<<<<<<<<<
 *         # Length unspecified, take it from the provided array
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "src/include/numerical_pyrex.pyx":51
 *             var[0] = <long> val
 *         else:
 *             var[0] = val             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "src/include/numerical_pyrex.pyx":53
 *             var[0] = val
 * 
 *     elif var[0] != val:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "src/include/numerical_pyrex.pyx":56
 *         # Length already specified, but not the same
 *         raise ValueError("%s dimension is %s, expected %s" %
 *                 (dimension, val, var[0]))             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    ...
    /* "src/include/numerical_pyrex.pyx":55
 *     elif var[0] != val:
 *         # Length already specified, but not the same
 *         raise ValueError("%s dimension is %s, expected %s" %             # <<<<<<<<<<<<<<
 *                 (dimension, val, var[0]))
 ...
 */
  ...
  /* "src/include/numerical_pyrex.pyx":59
 *     else:
 *         # Length matches what was expected
 *         pass             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "src/include/numerical_pyrex.pyx":47
 *             var[0] = <int> val
 *         elif dim is long:
 *             if val > LONG_MAX:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (unlikely(__pyx_t_1)) {
      ...
      /* "src/include/numerical_pyrex.pyx":48
 *         elif dim is long:
 *             if val > LONG_MAX:
 *                 raise ValueError("%s dimension is %s, too big" % (dimension, val))             # <<<<<<<<<<<<<<
 *             var[0] = <long> val
 ...
 */
    ...
    /* "src/include/numerical_pyrex.pyx":49
 *             if val > LONG_MAX:
 *                 raise ValueError("%s dimension is %s, too big" % (dimension, val))
 *             var[0] = <long> val             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "src/include/numerical_pyrex.pyx":43
 *         # Length unspecified, take it from the provided array
 *         if dim is int:
 *             if val > INT_MAX:             # <<<<<<<<<<<<<<
 *                 raise ValueError("%s dimension is %s, too big" % (dimension, val))
 ...
 */
    ...
    if (unlikely(__pyx_t_1)) {
      ...
      /* "src/include/numerical_pyrex.pyx":44
 *         if dim is int:
 *             if val > INT_MAX:
 *                 raise ValueError("%s dimension is %s, too big" % (dimension, val))             # <<<<<<<<<<<<<<
 *             var[0] = <int> val
 ...
 */
    ...
    /* "src/include/numerical_pyrex.pyx":45
 *             if val > INT_MAX:
 *                 raise ValueError("%s dimension is %s, too big" % (dimension, val))
 *             var[0] = <int> val             # <<<<<<<<<<<<<<
 *         elif dim is long:
...
/* "src/include/numerical_pyrex.pyx":62
 * 
 * 
...
static int __pyx_fuse_1_2__pyx_f_7cogent3_5align_14_pairwise_seqs_checkArray1D(__Pyx_memviewslice __pyx_v_a, int *__pyx_v_x) {
  ...
  /* "src/include/numerical_pyrex.pyx":63
 * 
 * cdef int checkArray1D(num[::1] a, dim *x) except 1:
 *     if a is None:             # <<<<<<<<<<<<<<
 *         raise ValueError('Array required, got None')
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "src/include/numerical_pyrex.pyx":64
 * cdef int checkArray1D(num[::1] a, dim *x) except 1:
 *     if a is None:
 *         raise ValueError('Array required, got None')             # <<<<<<<<<<<<<<
 *     checkDim('1st', a.shape[0], x)
 ...
 */
  ...
  /* "src/include/numerical_pyrex.pyx":65
 *     if a is None:
 *         raise ValueError('Array required, got None')
 *     checkDim('1st', a.shape[0], x)             # <<<<<<<<<<<<<<
 * 
...
/* "src/include/numerical_pyrex.pyx":67
 *     checkDim('1st', a.shape[0], x)
 * 
 * cdef int checkArray2D(num[:, ::1] a, dim *x, dim *y) except 1:             # <<<<<<<<<<<<<<
 *     if a is None:
...
static int __pyx_fuse_0_2__pyx_f_7cogent3_5align_14_pairwise_seqs_checkArray2D(__Pyx_memviewslice __pyx_v_a, int *__pyx_v_x, int *__pyx_v_y) {
  ...
  /* "src/include/numerical_pyrex.pyx":68
 * 
 * cdef int checkArray2D(num[:, ::1] a, dim *x, dim *y) except 1:
 *     if a is None:             # <<<<<<<<<<<<<<
 *         raise ValueError('Array required, got None')
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "src/include/numerical_pyrex.pyx":69
 * cdef int checkArray2D(num[:, ::1] a, dim *x, dim *y) except 1:
 *     if a is None:
 *         raise ValueError('Array required, got None')             # <<<<<<<<<<<<<<
 *     checkDim('1st', a.shape[0], x)
 ...
 */
  ...
  /* "src/include/numerical_pyrex.pyx":70
 *     if a is None:
 *         raise ValueError('Array required, got None')
 *     checkDim('1st', a.shape[0], x)             # <<<<<<<<<<<<<<
 *     checkDim('2nd', a.shape[1], y)
 ...
 */
  ...
  /* "src/include/numerical_pyrex.pyx":71
 *         raise ValueError('Array required, got None')
 *     checkDim('1st', a.shape[0], x)
 *     checkDim('2nd', a.shape[1], y)             # <<<<<<<<<<<<<<
 * 
...
/* "src/include/numerical_pyrex.pyx":73
 *     checkDim('2nd', a.shape[1], y)
 * 
 * cdef int checkArray3D(num[:, :, ::1] a, dim *x, dim *y, dim *z) except 1:             # <<<<<<<<<<<<<<
 *     if a is None:
...
static int __pyx_fuse_0_2__pyx_f_7cogent3_5align_14_pairwise_seqs_checkArray3D(__Pyx_memviewslice __pyx_v_a, int *__pyx_v_x, int *__pyx_v_y, int *__pyx_v_z) {
  ...
  /* "src/include/numerical_pyrex.pyx":74
 * 
 * cdef int checkArray3D(num[:, :, ::1] a, dim *x, dim *y, dim *z) except 1:
 *     if a is None:             # <<<<<<<<<<<<<<
 *         raise ValueError('Array required, got None')
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "src/include/numerical_pyrex.pyx":75
 * cdef int checkArray3D(num[:, :, ::1] a, dim *x, dim *y, dim *z) except 1:
 *     if a is None:
 *         raise ValueError('Array required, got None')             # <<<<<<<<<<<<<<
 *     checkDim('1st', a.shape[0], x)
 ...
 */
  ...
  /* "src/include/numerical_pyrex.pyx":76
 *     if a is None:
 *         raise ValueError('Array required, got None')
 *     checkDim('1st', a.shape[0], x)             # <<<<<<<<<<<<<<
 *     checkDim('2nd', a.shape[1], y)
 ...
 */
  ...
  /* "src/include/numerical_pyrex.pyx":77
 *         raise ValueError('Array required, got None')
 *     checkDim('1st', a.shape[0], x)
 *     checkDim('2nd', a.shape[1], y)             # <<<<<<<<<<<<<<
 *     checkDim('3rd', a.shape[2], z)
 ...
 */
  ...
  /* "src/include/numerical_pyrex.pyx":78
 *     checkDim('1st', a.shape[0], x)
 *     checkDim('2nd', a.shape[1], y)
 *     checkDim('3rd', a.shape[2], z)             # <<<<<<<<<<<<<<
 * 
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_2019_11_15_a, __pyx_k_2019_11_15_a, sizeof(__pyx_k_2019_11_15_a), 0, 0, 1, 0},
  ...
  {&__pyx_kp_s_src_cogent3_align__pairwise_seqs, __pyx_k_src_cogent3_align__pairwise_seqs, sizeof(__pyx_k_src_cogent3_align__pairwise_seqs), 0, 0, 1, 0},
 ...
 */
  ...
  __pyx_codeobj__25 = (PyObject*)__Pyx_PyCode_New(20, 0, 77, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__24, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_cogent3_align__pairwise_seqs, __pyx_n_s_calc_rows, 35, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__25)) __PYX_ERR(1, 35, __pyx_L1_error)
 ...
 */
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_version, __pyx_kp_s_2019_11_15_a) < 0) __PYX_ERR(0, 13, __pyx_L1_error)
 ...
 */
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_version, __pyx_kp_s_2019_11_15_a) < 0) __PYX_ERR(1, 17, __pyx_L1_error)
