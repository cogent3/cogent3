...
"""
from cogent3.parse.locuslink import ll_start, LLFinder, pipes, first_pipe, commas, \
...
PMID: 14499652"""
        ...
        self.assertEqual(first.NM, [{'Accession': 'NM_130786', 'Gi': '21071029',
                                     'Strain': 'na'}])
        self.assertEqual(
            first.NP, [{'Accession': 'NP_570602', 'Gi': '21071030'}])
        ...
        self.assertEqual(first.ASSEMBLY, [
                         ['AF414429', 'AK055885', 'AK056201']])
        ...
        self.assertEqual(
            first.PMID, ['12477932', '8889549', '3458201', '2591067'])
