...
class TestConstructorFunctions(unittest.TestCase):
    def test_make_aligned_seqs(self):
        ...
        # info works
        got = make_aligned_seqs(data, info={"a": 2})
        assert got.info["a"] == 2
        ...
        for src in ("somewhere", pathlib.Path("somewhere")):
            ...
            assert got.info["source"] == str(src)
    ...
    def test_load_unaligned_seqs_from_json(self):
        ...
        with TemporaryDirectory(dir=".") as dirname:
            ...
            assert got.to_dict() == unaligned.to_dict()
            assert got.info["source"] == path
    ...
    def test_load_aligned_seqs_from_json(self):
        ...
        with TemporaryDirectory(dir=".") as dirname:
            ...
            assert isinstance(got, Alignment)
            assert got.moltype.label == "dna"
            assert got.to_dict() == alignment.to_dict()
            assert got.info["source"] == path
            # tests case ArrayAlignment
            got = load_aligned_seqs(array_alignment_json_path)
            assert isinstance(got, ArrayAlignment)
            assert got.moltype.label == "dna"
            assert got.to_dict() == array_alignment.to_dict()
            assert got.info["source"] == path
...
class AlignmentTestMethods(unittest.TestCase):
    ...
    def test_num_seqs(self):
        assert self.alignment.num_seqs == 5
    ...
    def test_slice_align(self):
        ...
        assert len(sub_align.names) == 3
        assert sub_align.to_dict() == {"seq1": "GTA", "seq2": "GTA", "seq3": "GTA"}

        sub_align = alignment[5:20]
        assert len(sub_align) == 3
        assert len(sub_align.names) == 3
        assert sub_align.to_dict() == {"seq1": "CGT", "seq2": "CGT", "seq3": "CGT"}

        sub_align = alignment[2]
        assert len(sub_align) == 1
        assert sub_align.to_dict() == {"seq1": "G", "seq2": "G", "seq3": "G"}

        sub_align = alignment[0]
        assert len(sub_align) == 1
        assert sub_align.to_dict() == {"seq1": "A", "seq2": "A", "seq3": "A"}

        sub_align = alignment[7]
        assert len(sub_align) == 1
        assert sub_align.to_dict() == {"seq1": "T", "seq2": "T", "seq3": "T"}
    ...
    def test_sliding_windows(self):
        ...
        result = list(alignment.sliding_windows(5, 2))
    ...
    def test_omit_gap_pos1(self):
        ...
        assert align_dict == {"seq1": "ACGT-GT", "seq2": "ACGTAGT", "seq3": "ACGTAGT"}
    ...
    def test_omit_gap_pos2(self):
        ...
        assert align_dict == {"seq1": "ACGTGT", "seq2": "ACGTGT", "seq3": "ACGTGT"}
    ...
    def test_degap(self):
        ...
        assert observed.to_dict() == expect
    ...
    def test_DnaRna_interconversion(self):
        ...
        assert collect_Rna.to_dna().to_dict() == dna
        assert collect_Dna.to_rna().to_dict() == rna
        ...
        assert rna_from_dna.to_dict() == rna
        assert dna_from_rna.to_dict() == dna
    ...
    def test_reverse_complement(self):
        ...
        aln_rc = aln.rc()
        assert aln_rc.to_dict() == dna_rc
        # check collection, with gaps
        coll = make_unaligned_seqs(data=dna, moltype=DNA)
        coll_rc = coll.rc()
        assert coll_rc.to_dict() == dna_rc
        assert coll_rc.to_dict() == coll.reverse_complement().to_dict()
    ...
    def test_replace_seqs(self):
        ...
        for taxon, expected_sequence in [
            ...
            assert result[taxon] == expected_sequence
    ...
    def test_sample(self):
        ...
        for char in seqs[0]:
            assert seqs[0].count(char) == 1

    def test_sample_with_replacement(self):
        # test with replacement
        alignment = make_aligned_seqs(data={"seq1": "gatc", "seq2": "gatc"})
        alignment.sample(1000, with_replacement=True)
...
class SequenceTestMethods(unittest.TestCase):
    ...
    def test_get_in_motif_size(self):
        ...
        assert list(self.seq.get_in_motif_size(2)) == [
            "AT",
            "GA",
            "CG",
            "TT",
        ...
        assert list(self.seq.get_in_motif_size(3)) == [
            "ATG",
            "ACG",
            "TTG",
            "CGT",
    ...
    def test_slidingWindows(self):
        ...
        for bit in self.seq.sliding_windows(5, 1, start=3, end=6):
            result += [bit]
        assert [str(x) for x in result] == ["ACGTT", "CGTTG", "GTTGC"]
...
@pytest.fixture(params=("gb", "gbk", "gbff"))
...
def test_make_unaligned_seqs(new_type, seq_type, path_type):
    ...
    # info works
    got = make_unaligned_seqs(data, moltype="dna", info={"a": 2})
    assert got.info["a"] == 2
