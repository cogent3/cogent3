...
filterwarnings(
    "ignore", message="using slow exponentiator.+", category=UserWarning, append=True
)
filterwarnings(
    "ignore",
...
def suite():
    modules_to_test = [
        ...
        "test_maths.test_stats.test_number",
