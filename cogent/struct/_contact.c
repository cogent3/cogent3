/* Generated by Cython 0.12.1 on Thu Nov 25 11:38:39 2010 */
...
/* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":17
 * #        NPY_OWNDATA
 * 
...
static PyObject *__pyx_pf_6cogent_6struct_8_contact_cnt_loop(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      __pyx_v_search_limit = __pyx_PyFloat_AsDouble(PyTuple_GET_ITEM(__pyx_args, 8)); if (unlikely((__pyx_v_search_limit == (npy_float64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":31
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":32
 *     #const
 *     cdef UTYPE_t asu_atoms = shape1 * shape2
 *     search_limit = search_limit * search_limit             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":38
 * 
 *     #c arrays from numpy
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":39
 *     #c arrays from numpy
 *     cdef DTYPE_t *qcoords_c = <DTYPE_t *>qcoords.data
 *     cdef DTYPE_t *lcoords_c = <DTYPE_t *>lcoords.data             # <<<<<<<<<<<<<<
 *     cdef DTYPE_t *box_c = <DTYPE_t *>box.data
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":40
 *     cdef DTYPE_t *qcoords_c = <DTYPE_t *>qcoords.data
 *     cdef DTYPE_t *lcoords_c = <DTYPE_t *>lcoords.data
 *     cdef DTYPE_t *box_c = <DTYPE_t *>box.data             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":43
 * 
 *     #malloc'ed pointers
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":44
 *     #malloc'ed pointers
 *     cdef UTYPE_t **idxptr = <UTYPE_t **>malloc(sizeof(UTYPE_t*))
 *     cdef DTYPE_t **dstptr = <DTYPE_t **>malloc(sizeof(DTYPE_t*))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":53
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":54
 *     cdef DTYPE_t  t_dst # distance
 *     cdef DTYPE_t *t_arr = <DTYPE_t *>malloc(3 * MAXSYM * sizeof(DTYPE_t))    # temporary array of symmetry
 *     cdef UTYPE_t *t_lid = <UTYPE_t *>malloc(    MAXSYM * sizeof(UTYPE_t))    # maping to original indices             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":63
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":64
 * 
 *     cdef np.ndarray[UTYPE_t, ndim=1] c_src = np.ndarray((MAXCNT,), dtype=np.uint64)
 *     cdef np.ndarray[UTYPE_t, ndim=1] c_asu = np.ndarray((MAXCNT,), dtype=np.uint64)             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[UTYPE_t, ndim=1] c_sym = np.ndarray((MAXCNT,), dtype=np.uint64)
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":65
 *     cdef np.ndarray[UTYPE_t, ndim=1] c_src = np.ndarray((MAXCNT,), dtype=np.uint64)
 *     cdef np.ndarray[UTYPE_t, ndim=1] c_asu = np.ndarray((MAXCNT,), dtype=np.uint64)
 *     cdef np.ndarray[UTYPE_t, ndim=1] c_sym = np.ndarray((MAXCNT,), dtype=np.uint64)             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[UTYPE_t, ndim=1] c_tra = np.ndarray((MAXCNT,), dtype=np.uint64)
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":66
 *     cdef np.ndarray[UTYPE_t, ndim=1] c_asu = np.ndarray((MAXCNT,), dtype=np.uint64)
 *     cdef np.ndarray[UTYPE_t, ndim=1] c_sym = np.ndarray((MAXCNT,), dtype=np.uint64)
 *     cdef np.ndarray[UTYPE_t, ndim=1] c_tra = np.ndarray((MAXCNT,), dtype=np.uint64)             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[DTYPE_t, ndim=1] c_dst = np.ndarray((MAXCNT,), dtype=np.float64)
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":67
 *     cdef np.ndarray[UTYPE_t, ndim=1] c_sym = np.ndarray((MAXCNT,), dtype=np.uint64)
 *     cdef np.ndarray[UTYPE_t, ndim=1] c_tra = np.ndarray((MAXCNT,), dtype=np.uint64)
 *     cdef np.ndarray[DTYPE_t, ndim=1] c_dst = np.ndarray((MAXCNT,), dtype=np.float64)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":71
 *     # create a temporary array of lattice points, which are within a box around
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":72
 *     # the query atoms. The kd-tree will be constructed from those filterd atoms.
 *     lidx_c = 0
 *     for 0 <= lidx < lcoords.shape[0]:             # <<<<<<<<<<<<<<
 *         t_ptr = lcoords_c + lidx * 3
 ...
 */
  ...
  for (__pyx_v_lidx = 0; __pyx_v_lidx < __pyx_t_5; __pyx_v_lidx++) {
    ...
    /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":73
 *     lidx_c = 0
 *     for 0 <= lidx < lcoords.shape[0]:
 *         t_ptr = lcoords_c + lidx * 3             # <<<<<<<<<<<<<<
 *         if  box_c[0] <= (t_ptr  )[0] <= box_c[3] and\
 ...
 */
    ...
    /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":74
 *     for 0 <= lidx < lcoords.shape[0]:
 *         t_ptr = lcoords_c + lidx * 3
 *         if  box_c[0] <= (t_ptr  )[0] <= box_c[3] and\             # <<<<<<<<<<<<<<
 *             box_c[1] <= (t_ptr+1)[0] <= box_c[4] and\
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":75
 *         t_ptr = lcoords_c + lidx * 3
 *         if  box_c[0] <= (t_ptr  )[0] <= box_c[3] and\
 *             box_c[1] <= (t_ptr+1)[0] <= box_c[4] and\             # <<<<<<<<<<<<<<
 *             box_c[2] <= (t_ptr+2)[0] <= box_c[5]:
 ...
 */
      ...
      if (__pyx_t_8) {
        ...
        /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":76
 *         if  box_c[0] <= (t_ptr  )[0] <= box_c[3] and\
 *             box_c[1] <= (t_ptr+1)[0] <= box_c[4] and\
 *             box_c[2] <= (t_ptr+2)[0] <= box_c[5]:             # <<<<<<<<<<<<<<
 *             t_arr[3*lidx_c  ] = (t_ptr  )[0]
 ...
 */
    ...
    if (__pyx_t_8) {
      ...
      /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":77
 *             box_c[1] <= (t_ptr+1)[0] <= box_c[4] and\
 *             box_c[2] <= (t_ptr+2)[0] <= box_c[5]:
 *             t_arr[3*lidx_c  ] = (t_ptr  )[0]             # <<<<<<<<<<<<<<
 *             t_arr[3*lidx_c+1] = (t_ptr+1)[0]
 ...
 */
      ...
      /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":78
 *             box_c[2] <= (t_ptr+2)[0] <= box_c[5]:
 *             t_arr[3*lidx_c  ] = (t_ptr  )[0]
 *             t_arr[3*lidx_c+1] = (t_ptr+1)[0]             # <<<<<<<<<<<<<<
 *             t_arr[3*lidx_c+2] = (t_ptr+2)[0]
 ...
 */
      ...
      /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":79
 *             t_arr[3*lidx_c  ] = (t_ptr  )[0]
 *             t_arr[3*lidx_c+1] = (t_ptr+1)[0]
 *             t_arr[3*lidx_c+2] = (t_ptr+2)[0]             # <<<<<<<<<<<<<<
 *             t_lid[lidx_c] = lidx
 ...
 */
      ...
      /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":80
 *             t_arr[3*lidx_c+1] = (t_ptr+1)[0]
 *             t_arr[3*lidx_c+2] = (t_ptr+2)[0]
 *             t_lid[lidx_c] = lidx             # <<<<<<<<<<<<<<
 *             lidx_c += 1
 ...
 */
      ...
      /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":81
 *             t_arr[3*lidx_c+2] = (t_ptr+2)[0]
 *             t_lid[lidx_c] = lidx
 *             lidx_c += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":86
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":87
 *     cdef npy_intp neighbor_number
 *     cdef kdpoint *kdpnts = points(t_arr, lidx_c, 3)
 *     cdef kdnode  *tree = build_tree(kdpnts, 0, lidx_c - 1, 3, bucket_size, 0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":89
 *     cdef kdnode  *tree = build_tree(kdpnts, 0, lidx_c - 1, 3, bucket_size, 0)
 * 
 *     idxc = 0             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":91
 *     idxc = 0
 *     # loop over every query atom
 *     for 0 <= idx < qcoords.shape[0]:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_v_idx = 0; __pyx_v_idx < __pyx_t_5; __pyx_v_idx++) {
    ...
    /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":92
 *     # loop over every query atom
 *     for 0 <= idx < qcoords.shape[0]:
 *         search_point.coords = qcoords_c + idx*3             # <<<<<<<<<<<<<<
 *         neighbor_number = <npy_intp>rn(tree, kdpnts, search_point, dstptr, idxptr, search_limit, 3, 100)
 ...
 */
    ...
    /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":93
 *     for 0 <= idx < qcoords.shape[0]:
 *         search_point.coords = qcoords_c + idx*3
 *         neighbor_number = <npy_intp>rn(tree, kdpnts, search_point, dstptr, idxptr, search_limit, 3, 100)             # <<<<<<<<<<<<<<
 *         # loop over all neighbors
 ...
 */
    ...
    /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":95
 *         neighbor_number = <npy_intp>rn(tree, kdpnts, search_point, dstptr, idxptr, search_limit, 3, 100)
 *         # loop over all neighbors
 *         for 0 <= idxn < neighbor_number:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    for (__pyx_v_idxn = 0; __pyx_v_idxn < __pyx_t_11; __pyx_v_idxn++) {
      ...
      /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":96
 *         # loop over all neighbors
 *         for 0 <= idxn < neighbor_number:
 *             t_dst =  dstptr[0][idxn]        # the distance of the neighbor to the query             # <<<<<<<<<<<<<<
 *             if t_dst <= 0.001:              # its the same atom, skipping.
 ...
 */
      ...
      /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":97
 *         for 0 <= idxn < neighbor_number:
 *             t_dst =  dstptr[0][idxn]        # the distance of the neighbor to the query
 *             if t_dst <= 0.001:              # its the same atom, skipping.             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      if (__pyx_t_8) {
        ...
        /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":98
 *             t_dst =  dstptr[0][idxn]        # the distance of the neighbor to the query
 *             if t_dst <= 0.001:              # its the same atom, skipping.
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":100
 *                 continue
 * 
 *             t_idx =  kdpnts[idxptr[0][idxn]].index     # real index in t_arr array             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":101
 * 
 *             t_idx =  kdpnts[idxptr[0][idxn]].index     # real index in t_arr array
 *             t_idx =  t_lid[t_idx]                      # real index in lcoords array             # <<<<<<<<<<<<<<
 *             t_asu =  t_idx % shape2                    # 0 .. N -1, atom number
 ...
 */
      ...
      /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":102
 *             t_idx =  kdpnts[idxptr[0][idxn]].index     # real index in t_arr array
 *             t_idx =  t_lid[t_idx]                      # real index in lcoords array
 *             t_asu =  t_idx % shape2                    # 0 .. N -1, atom number             # <<<<<<<<<<<<<<
 *             t_sym = (t_idx // shape2) % shape1         # 0 .. MXS -1, symmetry number
 ...
 */
      ...
      /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":103
 *             t_idx =  t_lid[t_idx]                      # real index in lcoords array
 *             t_asu =  t_idx % shape2                    # 0 .. N -1, atom number
 *             t_sym = (t_idx // shape2) % shape1         # 0 .. MXS -1, symmetry number             # <<<<<<<<<<<<<<
 *             t_tra =  t_idx // asu_atoms                # 0 .. (2n + 1)^2 -1, translation number
 ...
 */
      ...
      /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":104
 *             t_asu =  t_idx % shape2                    # 0 .. N -1, atom number
 *             t_sym = (t_idx // shape2) % shape1         # 0 .. MXS -1, symmetry number
 *             t_tra =  t_idx // asu_atoms                # 0 .. (2n + 1)^2 -1, translation number             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":106
 *             t_tra =  t_idx // asu_atoms                # 0 .. (2n + 1)^2 -1, translation number
 * 
 *             if t_tra == zero_tra:  # same unit cell             # <<<<<<<<<<<<<<
 *                 if (mode == 0):
 ...
 */
      ...
      if (__pyx_t_8) {
        ...
        /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":107
 * 
 *             if t_tra == zero_tra:  # same unit cell
 *                 if (mode == 0):             # <<<<<<<<<<<<<<
 *                     continue
 ...
 */
        ...
        if (__pyx_t_8) {
          ...
          /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":108
 *             if t_tra == zero_tra:  # same unit cell
 *                 if (mode == 0):
 *                     continue             # <<<<<<<<<<<<<<
 *                 elif (mode == 1) and (t_sym == 0): # same asymmetric unit
 ...
 */
        ...
        /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":109
 *                 if (mode == 0):
 *                     continue
 *                 elif (mode == 1) and (t_sym == 0): # same asymmetric unit             # <<<<<<<<<<<<<<
 *                     continue
 ...
 */
        ...
        if (__pyx_t_10) {
          ...
          /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":110
 *                     continue
 *                 elif (mode == 1) and (t_sym == 0): # same asymmetric unit
 *                     continue             # <<<<<<<<<<<<<<
 *                 elif (mode == 2) and (qc[idx] == lc[t_asu]) and (t_sym == 0): #
 ...
 */
        ...
        /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":111
 *                 elif (mode == 1) and (t_sym == 0): # same asymmetric unit
 *                     continue
 *                 elif (mode == 2) and (qc[idx] == lc[t_asu]) and (t_sym == 0): #             # <<<<<<<<<<<<<<
 *                     continue
 ...
 */
        ...
        if (__pyx_t_8) {
          ...
          /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":112
 *                     continue
 *                 elif (mode == 2) and (qc[idx] == lc[t_asu]) and (t_sym == 0): #
 *                     continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":115
 * 
 *             # safe valid contact
 *             c_src[idxc] = idx             # <<<<<<<<<<<<<<
 *             c_asu[idxc] = t_asu
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(__pyx_t_6cogent_6struct_8_contact_UTYPE_t *, __pyx_bstruct_c_src.buf, __pyx_t_14, __pyx_bstride_0_c_src) = __pyx_v_idx;
      ...
      /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":116
 *             # safe valid contact
 *             c_src[idxc] = idx
 *             c_asu[idxc] = t_asu             # <<<<<<<<<<<<<<
 *             c_sym[idxc] = t_sym
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(__pyx_t_6cogent_6struct_8_contact_UTYPE_t *, __pyx_bstruct_c_asu.buf, __pyx_t_15, __pyx_bstride_0_c_asu) = __pyx_v_t_asu;
      ...
      /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":117
 *             c_src[idxc] = idx
 *             c_asu[idxc] = t_asu
 *             c_sym[idxc] = t_sym             # <<<<<<<<<<<<<<
 *             c_tra[idxc] = t_tra
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(__pyx_t_6cogent_6struct_8_contact_UTYPE_t *, __pyx_bstruct_c_sym.buf, __pyx_t_16, __pyx_bstride_0_c_sym) = __pyx_v_t_sym;
      ...
      /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":118
 *             c_asu[idxc] = t_asu
 *             c_sym[idxc] = t_sym
 *             c_tra[idxc] = t_tra             # <<<<<<<<<<<<<<
 *             c_dst[idxc] = t_dst
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(__pyx_t_6cogent_6struct_8_contact_UTYPE_t *, __pyx_bstruct_c_tra.buf, __pyx_t_17, __pyx_bstride_0_c_tra) = __pyx_v_t_tra;
      ...
      /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":119
 *             c_sym[idxc] = t_sym
 *             c_tra[idxc] = t_tra
 *             c_dst[idxc] = t_dst             # <<<<<<<<<<<<<<
 *             idxc += 1
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(__pyx_t_6cogent_6struct_8_contact_DTYPE_t *, __pyx_bstruct_c_dst.buf, __pyx_t_18, __pyx_bstride_0_c_dst) = __pyx_v_t_dst;
      ...
      /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":120
 *             c_tra[idxc] = t_tra
 *             c_dst[idxc] = t_dst
 *             idxc += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":122
 *             idxc += 1
 * 
 *     free(t_arr)             # <<<<<<<<<<<<<<
 *     free(t_lid)
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":123
 * 
 *     free(t_arr)
 *     free(t_lid)             # <<<<<<<<<<<<<<
 *     # free KD-Tree
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":125
 *     free(t_lid)
 *     # free KD-Tree
 *     free(idxptr[0])             # <<<<<<<<<<<<<<
 *     free(idxptr)
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":126
 *     # free KD-Tree
 *     free(idxptr[0])
 *     free(idxptr)             # <<<<<<<<<<<<<<
 *     free(dstptr)
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":127
 *     free(idxptr[0])
 *     free(idxptr)
 *     free(dstptr)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":141
...
#endif
{
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":2
 * cimport cython
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "/Users/gavin/DevRepos/PyCogent-trunk/cogent/struct/_contact.pyx":8
 ...
 */
  ...
  /* "/Users/gavin/DevSandbox/trunk/lib/python2.6/site-packages/Cython-0.12.1-py2.6-macosx-10.6-universal.egg/Cython/Includes/python_buffer.pxd":1
