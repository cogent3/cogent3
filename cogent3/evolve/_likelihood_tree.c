...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "cogent3.evolve._likelihood_tree",
        "sources": [
            "cogent3/evolve/_likelihood_tree.pyx"
        ]
    },
    "module_name": "cogent3.evolve._likelihood_tree"
}
END: Cython Metadata */
 ...
 */
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_version, __pyx_kp_s_3_0a2) < 0) __PYX_ERR(1, 6, __pyx_L1_error)
