...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "cogent3.align._pairwise_pogs",
        "sources": [
            "cogent3/align/_pairwise_pogs.pyx"
        ]
    },
    "module_name": "cogent3.align._pairwise_pogs"
}
END: Cython Metadata */
 ...
 */
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_version, __pyx_kp_s_3_0a2) < 0) __PYX_ERR(1, 15, __pyx_L1_error)
