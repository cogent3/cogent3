---
title: "Extracting maximum likelihood estimates from a `model_result`"
---
...
::: {.callout-note}
Unless the model is time-reversible, the lengths in that table are not ENS ([Kaehler et al](https://www.ncbi.nlm.nih.gov/pubmed/28175284)). As we used a non-stationary nucleotide model in this example, the length values are a scalar used to adjust the matrices during optimisation.
:::
