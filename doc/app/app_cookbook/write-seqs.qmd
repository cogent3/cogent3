---
title: "Writing sequences and sequence alignments"
---
...
Interestingly, another file failed in the `keep_translatable` step. By design, these failures did not stop the rest of the pipeline from being run. In fact, the data store collects the [`NotCompleted`](https://scinexus.readthedocs.io/en/latest/howto/handle-failures.html), which store traceback information, allowing you to interrogate any failings.
