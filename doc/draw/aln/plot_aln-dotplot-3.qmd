---
title: "Assess alignment quality via dotplots"
image: plot_aln-dotplot-3.png
---
```{python}
#| echo: false
...
```{python}
#| echo: false
outpath = "draw/aln/plot_aln-dotplot-3.png"
...
::: {.callout-note}
The default parameters (of any program) are not always the best choice, but they are a good starting point for many alignments.
:::
