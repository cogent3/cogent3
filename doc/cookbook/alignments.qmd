---
title: "Sequence Collections and Alignments"
---
For loading collections of unaligned or aligned sequences see [Loading sequence collections from a file or url](loading_sequences.qmd#load-seqs).
...
for name in ["sample", "sample.fasta"]:
    path = Path(name)
...
### Filtering positions {#filter-positions}
